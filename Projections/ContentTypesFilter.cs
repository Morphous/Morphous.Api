...
namespace Morphous.Api.Projections {
    /*
                ...
                shape => {
                    ...
                    var f = Shape.Form(
                        ...
                        _Parts: Shape.SelectList(
                            Id: "contenttypes", Name: "xContentTypes",
                            Title: T("Content types 2"),
                            Description: T("Select some content types."),
                            Size: 10,
                            Multiple: true
                            ),
                        _PartsFree: Shape.TextBox(
                                Id: "contenttypesfree", Name: "ContentTypes",
